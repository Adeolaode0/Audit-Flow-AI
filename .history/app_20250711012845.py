...
def analyze_evidence():
    try:
        ...
        try:
            evidence_content = evidence_file.read().decode("utf-8")
        except UnicodeDecodeError:
            # Handle binary files or non-UTF-8 files
            return jsonify({"error": "Uploaded file is not a valid UTF-8 text file. Please upload a text-based file."}), 400
