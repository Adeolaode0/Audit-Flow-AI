...
def analyze_evidence():
    ...
    try:
        ...
        # Extract text from all files with size limits
        evidence_content = []
        ...
        for file in files:
            if file and allowed_file(file.filename):
                try:
                    ...
                    if len(text_content) > 10000:  # 10k characters per file
        ...
        # Ensure the prompt isn't too long for OpenAI
        max_prompt_length = 12000  # Conservative limit for GPT-3.5-turbo
